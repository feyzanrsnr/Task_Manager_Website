...
const TaskCard = ({id, title, description, startDate, endDate, status = "not_completed"}) => {
  ...
  const cardClasses = `bg-gradient-to-br from-blue-400 to-blue-300 backdrop-blur-md dark:bg-gradient-to-br dark:from-blue-700 dark:to-blue-500 rounded-2xl p-4 w-72 md:w-80 h-[180px]  md:h-[200px] max-h-[300px] text-white shadow-lg hover:transition-all hover:translate-y-2 cursor-pointer `;
